...
function rhr_ajax_submit() {
	...
	$response = json_encode( array( 'success'   => true, 
					'countup'   => rhb_count_ratings( array( 'post_ID' => mysql_real_escape_string(intval($_POST['postID'])), 'rating' => 'up') ),
					'countdown' => rhb_count_ratings( array( 'post_ID' => mysql_real_escape_string(intval($_POST['postID'])), 'rating' => 'down') ) ) );
